...
Following the preparation of the data, we transitioned into machine learning and predictive modelling. Using Scikit-Learn, we developed a pipeline that integrated feature scaling and categorical encoding. A decision tree classifier was implemented to investigate the drivers of crash severity. This model was chosen for its transparency, allowing us to perform feature selection and determine which variables—such as infrastructure presence or precipitation levels—were the strongest predictors of severe accidents. By splitting the data into training and testing sets, we were able to validate the model's performance through accuracy scores and confusion matrices, ensuring the insights were statistically sound before moving to the visualisation stage.
